...
const Hero = ({hero: {title, subtitle, btn1, btn2, img, text}}) => {
    return (
        <>
            <div className="flex flex-col bg-gradient-to-b from-emerald-200 to-white
            h-auto w-auto">
                <div className=" travigo-container grid items-start justify-items-center w-[85%]">
                    <div className=" grid items-center justify-items-center mt-36 mb-16 md:mt-28 md:mb-12">
                        ...
                        <div className="flex items-center gap-11 sm:gap-3 sm:flex-col sm:w-full">
                            <button type="button" className="button-emarald">{btn1}</button>
                            <button type="button" className="button-light">{btn2}</button>
                        </div>
                    </div>
                    <div className=" flex items-center justify-center mb-11">
                        <img alt="dashboard/img" src={img} className=" h-[85vh] w-full object-fill lg:h-[75vh]
